...
- **Theme & Vibe:** Ultra-modern dark SaaS aesthetic (Linear/Vercel style with 3D spatial UI).
- **Core Tech Stack:** Next.js, Tailwind CSS, Framer Motion, Three.js (`@react-three/fiber`, `@react-three/drei`), Lucide React.
- **Design Rules:**
